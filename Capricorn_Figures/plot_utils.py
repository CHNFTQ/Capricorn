...
def grouped_barplot(ax, nested_data, data_labels, xlabel, ylabel, xscale='linear', yscale='linear',
                    ...
                    tickloc_top=True, rotangle=45, legend_loc='upper right', anchorpoint='right', ecolor='w'):
...
def box_plot(ax, data, xlabel, ylabel, xticks=None, yticks=None, xticklabels=None, yticklabels=None,
    ...
    bplot = ax.boxplot(
        data, patch_artist=box_colors is not None, widths=widths, zorder=zorder, medianprops={'color': 'black'},
        positions=positions)
